...
+ Added extra validation in the controller to prevent users unauthorized access by using the address bar. (for instance, you can edit mod id 1 at */1/edit*, but typing in */2/edit* in the address bar when it is not yours will not allow access to editing mod id 2)
